...
public class DirectorAnalysis {
    static class DirectorMapper extends Mapper<LongWritable, Text, Text, MovierReviewBean> {
        /**
         * map方法一行数据执行一次  1000
        ...
        protected void map(LongWritable key, Text value, Context context)
            ...
            try {
                ...
                // k  赋值
                String director[] = v.getDirector().split(",");
    ...
    static class DirectorReducer extends Reducer<Text, MovierReviewBean, Text, IntWritable> {
